...
class Balloon(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.balloons = []
        self.balloons.append(pygame.transform.rotozoom(pygame.image.load("1.png"), 0, 0.4))
...
class Boom(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("1.png"), 0, 0.4))
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("2.png"), 0, 0.4))
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("3.png"), 0, 0.4))
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("4.png"), 0, 0.4))
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("5.png"), 0, 0.4))
        self.booms.append(pygame.transform.rotozoom(pygame.image.load("6.png"), 0, 0.4))
        self.pos_x = random.randint(100, 1820)
        self.pos_y = 1100
